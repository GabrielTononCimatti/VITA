...
export const getNotificationById = async (req, res) =>
{
    ...
    if(notification.senderID !== "users/"+req.currentUser.id && notification.receiverID !== "users/"+req.currentUser.id && req.currentUser.userType !== 'A')
        return res.status(403).send({message:"Erro 403: Forbidden. Acesso negado"});
...
export const putNotification = async (req, res) =>
{
...
export const readNotification = async (req, res) =>
{
    ...
    if("users/"+req.currentUser.id !== notification.receiverID)
        return res.status(403).send({message:"Erro 403: Forbidden. Acesso negado"});
